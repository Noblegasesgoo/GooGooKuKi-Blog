...
public class Swagger2Config {
    ...
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.zhao.blog.controller")) // 要生成文档的包
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("noblegasesgoo", "http://localhost:2235/doc.html", "26328168232qq.com"))
                .version("v1.0.0")
                .build();
    }
