...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, Article> implements IArticleService {
    ...
    public List<ArticleVo> listHotArticle(Integer count) {
        ...
        articleLambdaQueryWrapper.select(Article::getId, Article::getTitle).eq(Article::getIsDeleted, 0)
    ...
    public List<ArticleVo> listNewArticle() {
        ...
        LambdaQueryWrapper<Article> articleLambdaQueryWrapper = new LambdaQueryWrapper<>();
        articleLambdaQueryWrapper.select(Article::getId, Article::getTitle, Article::getGmtCreate).eq(Article::getIsDeleted, 0)
