...
public class Swagger2Config {
    ...
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.zhao.blog.admin.controller")) // 要生成文档的包
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                .title("博客后台管理系统接口文档")
                .description("博客后台管理系统接口文档")
                .contact(new Contact("noblegasesgoo", "http:localhost:2236/doc.html", "26328168232qq.com"))
                .version("v1.0.0")
                .build();
    }
